...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<IPuzzleSearch> searchTypes = new ArrayList<>();
        ...
        LinkedHashMap<String, PuzzleSolution> solutions = new LinkedHashMap<>();
        for (IPuzzleSearch searchType : searchTypes) {
            long startTime = System.currentTimeMillis();
            PuzzleSolution solution;
            System.out.print(searchType + " search:\n");
            solution = searchType.search(board);

            System.out.println("\t" + searchType + ":\n\t\t" + (solution.getFoundSolution() ? solution.getFullSolutionPath() : "no solution found"));
        ...
        for (String searchType : solutions.keySet()) {
            System.out.println("\t" + searchType + ":\n\t\t" + (solutions.get(searchType).getFoundSolution() ?
